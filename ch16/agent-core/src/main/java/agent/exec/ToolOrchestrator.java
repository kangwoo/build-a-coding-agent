...
public final class ToolOrchestrator {
    ...
    public ToolOrchestrator(ToolRegistry registry) { this(registry, PermissionGate.allowAll(), 10); }
    public ToolOrchestrator(ToolRegistry registry, PermissionGate gate) { this(registry, gate, 10); }
    public ToolOrchestrator(ToolRegistry registry, int maxConcurrency) {
        this(registry, PermissionGate.allowAll(), maxConcurrency);
    }
    public ToolOrchestrator(ToolRegistry registry, PermissionGate gate, int maxConcurrency) {
        this.registry = registry; this.gate = gate; this.maxConcurrency = maxConcurrency;
    }
